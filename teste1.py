...
bt_ponto = Button(master, text=".", bg="lightblue",pady=14, padx=15, bd=4)
...
bt_ce = Button(master, text="CE", bg="silver",pady=14, padx=10, bd=4)
bt_ce.place(x=160, y=100)

bt_multiplicar = Button(master, text="*", bg="silver",pady=14, padx=14, bd=4)
bt_multiplicar.place(x=160, y=155)

bt_somar = Button(master, text="+", bg="silver",pady=14, padx=13, bd=4)
...
bt_dividir = Button(master, text="/", bg="silver",pady=14, padx=14, bd=4)
bt_dividir.place(x=210, y=155)

bt_subtrair = Button(master, text="-", bg="silver",pady=14, padx=14, bd=4)
bt_subtrair.place(x=210, y=210)

bt_igual = Button(master, text="=", bg="green",pady=14, padx=12, bd=4)
